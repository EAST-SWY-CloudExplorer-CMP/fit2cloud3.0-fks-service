ProjectApp.controller('CustomGroupController', function ($scope, HttpUtils, FilterSearch, $http, Notification, operationArr, eyeService, $state, $stateParams, ProhibitPrompts, UserService, AuthService, Loading) {
        ...
        $scope.parentGroupDn=[];
        HttpUtils.get('system/parameter/getParameterValue/ldap.server.appDn' ,function (resp) {
...
ProjectApp.controller('CustomGroupMembersController', function ($scope, HttpUtils) {
